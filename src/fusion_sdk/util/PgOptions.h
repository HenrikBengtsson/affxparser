...
public: 
  ...
  public:
    ...
    const char *defaultVal;   ///< Default value if any.
    const char *value;        ///< Value supplied if any, NULL otherwise.
...
private:
  ...
  std::map<std::string, PgOpt *> optionMap; 
  ///< Original o ption specification for program.
  PgOpt **optSpec;            
