 ...
 */
	...
	FusionDatData* FusionFactory::CreateDatData()
{
	return GCOSDatData::Create();
}

/*
 * Creates a FusiontDatFileWriter object. Call Delete on the object to free memory
 */
FusionDatFileWriter* FusionFactory::CreateDatFileWriter()
{
	return GCOSDatFileWriter::Create();
}
