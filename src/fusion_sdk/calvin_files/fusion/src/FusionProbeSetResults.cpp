	...
	FusionGenotypeProbeSetResults::FusionGenotypeProbeSetResults()
{
	...
	int32_t FusionForceCallType::GetPosition()
	{
		return position;
	}

	int8_t FusionForceCallType::GetCall()
	{
		return call;
	}

	u_int8_t FusionForceCallType::GetReason()
	{
		return reason;
	}

	void FusionForceCallType::SetPosition(int32_t p)
	{
		position = p;
	}

	void FusionForceCallType::SetCall(int8_t p)
	{
		call = p;
	}

	void FusionForceCallType::SetReason(u_int8_t p)
	{
		reason = p;
	}
	...
	int32_t FusionBaseCallType::GetPosition()
	{
		return position;
	}

	int8_t FusionBaseCallType::GetCall()
	{
		return call;
	}

	void FusionBaseCallType::SetPosition(int32_t p)
	{
		position = p;
	}

	void FusionBaseCallType::SetCall(int8_t p)
	{
		call = p;
	}
